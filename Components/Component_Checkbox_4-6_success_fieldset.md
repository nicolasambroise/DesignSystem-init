```html
<fieldset class="cmp-form-options cmp-form-options--checkbox field-valid" aria-describedby="valid-checkboxes">
  ...
  <div class="alert alert--success">
    <p id="valid-checkboxes" class="valid" >Success message </p>
  </div>
</fieldset>
```