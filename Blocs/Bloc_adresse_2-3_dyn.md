...
<fieldset>
  ...
  <div class="form-group">
    ...
    <select id="city" name="city" class="form-field" autocomplete="address-level2" required>
    </select>
  </div>
  ...
  <div class="form-group opt-physical-address-visible">
    ...
    <select id="street" name="street" class="form-field" autocomplete="address-line1" required>
    </select>
  </div>
  <div class="form-group opt-physical-address-visible">
